...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "kkrishnan78-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/kkrishnan78"
  #   chef.validation_client_name = "kkrishnan78-validator"
  #   chef.validation_key_path = ".chef/kkrishnan78-validator.pem"
  # end
end
